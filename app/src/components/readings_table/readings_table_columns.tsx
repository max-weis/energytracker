...
export const columns: ColumnDef<Reading>[] = [
  {
    accessorKey: "type",
    header: "Type",
    cell: ({ row }) => row.getValue("type") === "electricity" ?
  ...
  },
  {
    ...
    cell: ({ row }) => <div className="text-right">{row.getValue("kwh_difference")}</div>,
  },
  {
    accessorKey: "kwh_difference_percentage",
    header: () => <div className="text-right">kWh Difference in %</div>,
    cell: ({ row }) => <div className="text-right">{row.getValue("kwh_difference_percentage")}</div>,
  },
  {
    accessorKey: "price",
    header: "Price",
    cell: ({ row }) => <div className="font-medium">{formatEuroCents(row.getValue("price"))}</div>,
  },
  {
    accessorKey: "base_price",
    header: "Base Price",
    cell: ({ row }) => <div className="font-medium">{formatEuroCents(row.getValue("base_price"))}</div>,
  },
  {
